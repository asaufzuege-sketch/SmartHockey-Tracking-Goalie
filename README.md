# SmartHockey Tracking Goalie

Goalie-only SmartHockey tracker for live shot logging, save maps, and season exports.

## Workflow

1. Open **Goalie Selection** and activate up to 10 goalies.
2. Choose the active goalie for the live **Game Center** table.
3. In Game Center:
